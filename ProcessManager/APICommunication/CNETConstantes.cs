...
namespace ProcessManager
{
    public static class CNETConstantes
    {
        ...
        public const int Activity_Printed = 1044;
        ...
        public const string PMS_SETTING_CheckOutType = "PMS Receipt Type";
        ...
        public const string PMS_SETTING_DefaultCheckOutPaymentType = "Check Out Payment Type";
        ...
        public const int LU_ACTIVITY_DEFINATION_Edit = 1022;
        ...
        public const int PAYMENTMETHODSCREDIT = 1749;
        ...
        public const int ADDTIONAL_CHARGE = 1957;
        public const int DISCOUNT = 1959;
        ...
        public const string Payment_Method_Detail_REPORT = "Payment Method Detail Report";
        public const string Payment_Method_Summary_REPORT = "Payment Method Summary Report";
        ...
        public static int ORGUNITTYPE_DEPARTMENT = 1720;
        public const string HOUSE_KEEPING_ATTENDANT = "Housekeeping Attendant";
        public const string HOUSE_KEEPING_DEPARTMENT = "HOUSEKEEPING DEPARTMENT";
        ...
        public const int Voucher = 767;
        public const int PMS_POS = 69;
        public const int Consignee_Customer = 28;
        public const int Org_Unit_Type_Branch = 1719;
        public const int LK_Activity_Maintained = 1000;
        public const int LK_Required_GSL_Consignee = 1835;
        public const int LK_Required_GSL_Article = 1834;
        public const int Payment_Method_Specialization_QR = 1756;
        public const int Payment_Status_Executed = 2007;
        public const string EVENT_CATEGORY = "Event Category";
        public const string EVENT_STATE = "Event Status";
        public const string EVENT_TYPE = "Event Type";
        public const string EVENT_ARRANGEMENT = "Space Arrangement";
        public const string EVENT_Department = "Event Department";
        public const int EVENT_VOUCHER = 349;
        public const int OSD_EVENTCHECKEDOUT = 1239;
        public const int OSD_EVENTConfirmed = 1256;
        public const int OSD_EVENTConducted = 1259;
        #region Value Rule
        public const string VALUE_RULE_FLEXIBLE = "FLEXIBLE";
        public const string VALUE_RULE_FIXED = "FIXED";
