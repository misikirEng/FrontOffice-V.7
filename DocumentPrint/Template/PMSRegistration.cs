...
{
    public partial class PMSRegistration : DevExpress.XtraReports.UI.XtraReport
    {
        public PMSRegistration(RegistrationPrintOutDTO registrationPrintOut, Bitmap? Signature)
        {
