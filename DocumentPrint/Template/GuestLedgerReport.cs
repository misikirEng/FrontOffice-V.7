...
namespace DocumentPrint
{
    public partial class GuestLedgerReport : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void LedgerParameters(string CustomerName, string CompanyName, string CompanyTIN,  string RegistrationNumber, string Plan, string FSNo, string TINNo, string ArrivalDate, string DepartureDate, int? ConsigneeUnit, string user)
        {
