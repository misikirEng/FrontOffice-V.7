...
{
    public partial class A5LineItemPrintOut : DevExpress.XtraReports.UI.XtraReport
    {
        public A5LineItemPrintOut(VoucherPrintModel voucherModel)
        {
            InitializeComponent();
            #region parameters
            ...
            #endregion
            xtraReference.Text = voucherModel?.voucherExtensionString;
            try
            {
                ...
                if (DocumentPrintSetting.CompanyAttachmentLogo != null)
                {
                    try
                    {
                        logPic.Image = DocumentPrintSetting.CompanyAttachmentLogo;
