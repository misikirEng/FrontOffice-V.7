...
{
    public class AdelLockNew : IDoorLock
    {
        ...
        public CardInfo ReadCardData(bool showStatusMessage = true)
        {
            ...
            try
            {
                ...
                int st = ReadCard(lockNumber, gate, sTime, null, null, null, null, null, ref cardNumber, ref status, 0);
                if (st == 0)
                {
        ...
        public bool IssueGuestCard(string lockNumber, DateTime startDate, DateTime endDate, bool isDuplicate = false)
        {
            try
            {
                ...
                if (isDuplicate)
                {
                    st = DupKey(sbLock, gate, sbTime, new StringBuilder("guest"), new StringBuilder("11"), null, overrideFlag, 0, ref cardSN, null, null);

                }
                else
                {
                    st = NewKey(sbLock, gate, sbTime, new StringBuilder("guest"), new StringBuilder("11"), null, overrideFlag, 0, ref cardSN, null, null);
        ...
        public static extern int NewKey(StringBuilder lockNumber, StringBuilder gate, StringBuilder stime, StringBuilder guestName, StringBuilder guestId, StringBuilder lift, short overwriteflag, short breakfast, ref long cardNumber, StringBuilder track1, StringBuilder track2);
        ...
        public static extern int DupKey(StringBuilder lockNumber, StringBuilder gate, StringBuilder stime, StringBuilder guestName, StringBuilder guestId, StringBuilder lift, short overwriteflag, short breakfast, ref long cardNumber, StringBuilder track1, StringBuilder track2);
        ...
        public static extern int ReadCard(StringBuilder lockNumber, StringBuilder gate, StringBuilder sTime, StringBuilder guestName, StringBuilder guestId, StringBuilder lift, StringBuilder track1, StringBuilder track2, ref long cardNo, ref short status, short Breakfast);
