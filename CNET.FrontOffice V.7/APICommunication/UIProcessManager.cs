...
namespace CNET.FrontOffice_V._7.APICommunication
{
    public class UIProcessManager
    {
        ...
        public static VoucherBuffer CreateVoucherBuffer(VoucherBuffer Voucher)
        {
            return Task.Run(async () => await transactionRequest.CreateVoucherBuffer(Voucher)).Result;
        }
        public static VoucherBuffer GetVoucherBufferById(int Id)
        {
            return Task.Run(async () => await transactionRequest.GetVoucherBufferById(Id)).Result;
        }

        public static VoucherBuffer UpdateVoucherBuffer(VoucherBuffer Voucher)
        {
        ...
        public static List<VoucherDTO> GetVoucherBylocalCode(string code)
        {
            try
            {
                Dictionary<string, string> Dictionaryvalue = new Dictionary<string, string>();
        ...
        public static List<VwRouteDetailViewDTO> GetAllRouteView()
        {
            try
            {
        ...
        public static List<DailyResidentSummaryReport> GetDailyResidentSummary(DateTime date,  int? consigneeunit)
        {
            try
            {
                return Task.Run(async () => await pmsReportRequest.GetDailyResidentSummary(date, consigneeunit)).Result;
            }
            catch (Exception ex)
            {
        ...
        public static List<CashDropDocumentReportDTO> GetCashDropreport(DateTime startdate, DateTime enddate, int? consigneeunit)
        {
            try
            {
                return Task.Run(async () => await pmsReportRequest.GetCashDropreport(startdate, enddate, consigneeunit)).Result;
            }
            catch (Exception ex)
            {
